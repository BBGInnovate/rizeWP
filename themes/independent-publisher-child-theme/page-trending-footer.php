...
<div id="focusMenu"><ul id="dropdown">


	<div id="focusMenu"><ul id="dropdown" style="display: block;">
		...
		<a href="<?php echo site_url() . "/"; ?>about"><li>Our mission</li></a></ul></div><div id='footerNav'>
	</ul></div>
