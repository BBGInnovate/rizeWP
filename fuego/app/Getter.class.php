			...
			foreach ($urls_chunked as $urls_chunk) {
				...
				foreach ($link_meta_chunk as $m) {
					...
					if ( isset ($m['thumbnail_url'] ) ) {
						...
						$imageSizeMax = IMAGE_SIZE_MAX; //Sets the max size for images to include as a thumbnail.
						$imageSizeMin = IMAGE_SIZE_MIN; //Sets the min size for images to include as a thumbnail.
